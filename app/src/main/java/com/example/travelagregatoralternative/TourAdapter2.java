...
public class TourAdapter2 extends RecyclerView.Adapter<TourAdapter2.ViewHolder> {

    ArrayList<Tour> a = null;

    public TourAdapter2(ArrayList<Tour> a) {
        this.a = a;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup vg, int i) {
        View v = LayoutInflater.from(vg.getContext()).inflate(R.layout.item_layout_recycler, vg, false);
